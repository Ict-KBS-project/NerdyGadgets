...
//functies voor informatie winkelmandje
# pak naam van product
function PakQueryName($stockItemID){ #naar databese.php
    $Query = "
...
# pak prijs van product
function PakQueryPrijs($stockItemID){
    $Query = "
        SELECT (TaxRate*RecommendedRetailPrice*0.01+RecommendedRetailPrice) as VerkoopPrijs
        from stockitems
        WHERE stockItemID = " . $stockItemID . " 
    ";
    return $Query;
